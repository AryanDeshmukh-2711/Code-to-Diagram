...
**Product:** Code to Diagram (earlier working names: AI Software Architect, UML Studio)
...
This document specifies the requirements for **Code to Diagram V1**, a web application that converts a natural-language project description or a requirements PDF into a consistent set of UML/ER diagrams and a formatted Software Requirements Specification document, exported as a submission-ready PDF or DOCX file.
